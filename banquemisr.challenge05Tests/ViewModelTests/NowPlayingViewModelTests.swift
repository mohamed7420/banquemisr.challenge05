...
class NowPlayingViewModelTests: XCTestCase {
    ...
    func testLoadPopularMovies() {
        ...
        Task {
            do {
                _ = try await viewModel.loadNowplayingMovies()
